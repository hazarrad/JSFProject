...
public class EmployeeServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String intergrationDate = request.getParameter("intergrationDate");
		
		EmployeeDTO employee = new EmployeeDTO(Integer.valueOf(number), firstName, lastName, Grade.valueOf(grade), email, password, Profile.valueOf(profile), LocalDate.parse(intergrationDate));
		...
		RequestDispatcher listView = request.getRequestDispatcher("views/employee.jsp");
