            ...
            <table id="tableEployee" class="table table-striped table-hover">
                ...
                <c:forEach var="project" items="${projectList}">
                    ...
                    <tr>
						...
						<td class="1"><c:out value='${project.id}' /></td>
                        <td class="1">${project.name}</td>
                        <td class="1">${project.startDate}</td>
                        <td class="1">${project.endDate}</td>
                        <td class="1">${project.description}</td>
                        <td><input type="submit"  onclick="showEditEmployeeForm('1')" ></td>
						<td>
							<form action="project" method="post">
								<input type="hidden" name="id" value="${project.id}">
		                       	<button id="addEmployeeButton" class="btn btn-danger" name="action" value="delete"><i class="fa fa-trash" aria-hidden="true"></i> <span class="inline-block align-middle" >Delete</span></button>				
							</form> 
						</td>
                       <td>
                            <a id="editEmployee" onclick="showEditEmployeeForm('${project.id}')" class="edit" data-toggle="modal" style="cursor: pointer;" cursor: pointer;><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
	            ...
	            <div id="addEmployeeForm" class="row" style="position:center">
	            	<div class="column" style="padding: 20px">
				        <div class="form-group">
							...
							<input id="number" name="nameproject" type="text" class="form-control" value="project1" required>
						</div>
						<div class="form-group">
							<label>Start Date</label>
							<input id="intergrationDate" name="startdate" type="date" class="form-control" value="01/10/2020" required>
						</div>
					...
					<div class="column" style="padding: 20px">
						...
						<div class="form-group">
							...
							<input id="intergrationDate" name="endDate" type="date" class="form-control" value="01/10/2020" required>
						</div>
						
						
						<div class="form-group">
							<label>Description</label>
							<input id="number" name="description" type="text" class="form-control" value="some description" required>
						</div>
	
						<button id="addEmployeeButton" class="btn btn-success" name="action" value="add"><i class="fa fa-plus-circle" aria-hidden="true"></i> <span class="inline-block align-middle" >Add Project</span></button>				
        ...
        <div class="table-wrapper">
            ...
            <form action="project" method="post">
	            <div id="editEmployeeForm" class="row" style="position:center">
	            	...
	            	<div class="form-group">
							<label>id</label>
							<input id="number" name="upid" type="text" class="form-control" value="${project.id}" required>
						</div>
				         <div class="form-group">
							<label>Name Project</label>
							<input id="number" name="upnameproject" type="text" class="form-control" value="${project.name}" required>
						</div>
						<div class="form-group">
							<label>Start Date</label>
							<input id="intergrationDate" name="upstartdate" type="date" class="form-control" value="${project.startDate}" required>
						</div>
					...
					<div class="column" style="padding: 20px">
						<div class="form-group">
							<label>End Date</label>
							<input id="intergrationDate" name="upendDate" type="date" class="form-control" value="${project.endDate}" required>
						</div>
						
						
						<div class="form-group">
							<label>Description</label>
							<input id="number" name="updescription" type="text" class="form-control" value="${project.description}" required>
						</div>
			
						<button id="editEmployeeButton" class="btn btn-warning" name="action" value="upTodate"><i class="fa fa-floppy-o" aria-hidden="true"></i> <span class="inline-block align-middle" >Update Project</span></button>					
